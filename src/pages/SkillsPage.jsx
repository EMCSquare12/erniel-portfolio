...
export default function SkillsPage() {
  ...
  const SkillNode = ({
    ...
    <div
      className={`absolute flex items-center space-x-3 ${positionClasses} z-20`}
    >
      {/* Icon Box */}
      <div
  ...
  return (
    <div className="max-w-7xl mx-auto space-y-6 pb-12">
      ...
      <div className="relative w-full h-[700px] bg-[#1c2128] border border-slate-700/50 rounded-2xl overflow-hidden shadow-2xl flex items-center justify-center">
        ...
        <div className="absolute top-6 left-6 w-64 bg-[#21262d]/80 backdrop-blur-sm border border-slate-600 p-4 rounded-xl z-30">
          ...
          />
          <p className="text-[10px] text-slate-500 mt-2">Years of Experience</p>
        </div>

        {/* TOP RIGHT: Analytic Tool Proficiency Card */}
        <div className="absolute top-6 right-6 w-64 bg-[#21262d]/80 backdrop-blur-sm border border-slate-600 p-4 rounded-xl z-30">
          <h3 className="text-white font-bold text-sm mb-3">
        ...
        {/* SECTION LABELS */}
        <div className="absolute top-12 left-1/4 text-xl font-bold text-blue-400/80 tracking-widest z-10">
          WEB DEVELOPMENT
        </div>
        <div className="absolute top-12 right-1/4 text-xl font-bold text-teal-400/80 tracking-widest z-10">
          DATA ANALYSIS
        </div>
        ...
        <SkillNode
          ...
          score={90}
          themeColor="blue"
          positionClasses="top-[25%] left-[25%] flex-row-reverse space-x-reverse"
        />
        <SkillNode
          icon="JS"
          title="JavaScript"
          ...
          score={90}
          themeColor="blue"
          positionClasses="top-[45%] left-[10%] flex-row-reverse space-x-reverse"
        />
        <SkillNode
          icon="EX"
          title="Express.js"
          ...
          score={90}
          themeColor="blue"
          positionClasses="bottom-[40%] left-[15%] flex-row-reverse space-x-reverse"
        />
        <SkillNode
          icon="🍃"
          title="MongoDB"
          ...
          score={90}
          themeColor="blue"
          positionClasses="bottom-[20%] left-[25%] flex-row-reverse space-x-reverse"
        />
        ...
        <SkillNode
          ...
          score={85}
          themeColor="teal"
          positionClasses="top-[25%] right-[25%]"
        />
        <SkillNode
          icon="🔄"
          title="Data Cleaning"
          ...
          score={85}
          themeColor="teal"
          positionClasses="top-[45%] right-[10%]"
        />
        <SkillNode
          icon="🗄️"
          title="SQL"
          ...
          score={85}
          themeColor="teal"
          positionClasses="bottom-[40%] right-[15%]"
        />
        <SkillNode
          icon="📈"
          title="Power BI"
          ...
          score={85}
          themeColor="teal"
          positionClasses="bottom-[20%] right-[25%]"
        />
      </div>
    </div>
  );
